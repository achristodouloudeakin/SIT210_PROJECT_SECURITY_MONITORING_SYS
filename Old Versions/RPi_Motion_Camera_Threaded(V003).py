...
def argon_notification_procedure():
    timer_x = 0
    while timer_x < 10:
        secondary_client = mqtt.Client("makeriio_mqtt")
    ...
    _thread.exit()
#     except:
#         print("Unable to Exit Thread for Argon 2 Connection")
#     
...
#         
#     except:
#         print("Unable to Exit Thread for Camera")
...
def message_function(client, userdata, message):
    ...
    if (range_in_centimetres < 100):
        ...
        print("Notifying User of Front Door Movement")
